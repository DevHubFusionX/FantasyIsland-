...
const Footer = () => {
  ...
  return (
  <footer id="contact" className="py-16 md:py-24 px-6 md:px-16 bg-obsidian border-t border-white/5">
    <div className="max-w-[1500px] mx-auto flex flex-col lg:flex-row justify-between items-center lg:items-start gap-12 lg:gap-24 text-center lg:text-left">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-10 md:gap-24 w-full lg:w-auto">
        <div>
          <h5 className="text-white uppercase tracking-[0.4em] text-[10px] font-bold mb-6 md:mb-8">Discover</h5>
        ...
        <div>
          <h5 className="text-white uppercase tracking-[0.4em] text-[10px] font-bold mb-6 md:mb-8">Support</h5>
          <ul className="space-y-5 text-white/30 text-[10px] uppercase tracking-[0.3em]">
        ...
        <div className="col-span-2 md:col-span-1">
          <h5 className="text-white uppercase tracking-[0.4em] text-[10px] font-bold mb-6 md:mb-8">Location</h5>
    ...
    <div className="max-w-[1500px] mx-auto mt-12 md:mt-24 pt-8 md:pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
      ...
      <p className="text-white/10 text-[9px] uppercase tracking-[0.3em] md:tracking-[0.6em] text-center md:text-right">
